...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    {/* Flex wrapper centers the content so the zoom/fade animation plays in
        place (translate-based centering would get clobbered by the keyframe,
        making the dialog fly in from the corner). */}
